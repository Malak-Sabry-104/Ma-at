        ...
        >
          ...
          <div
            className="
              ...
              rtl:md:rounded-tl-0 rtl:md:rounded-tr-2xl rtl:md:rounded-bl-0 rtl:md:rounded-br-2xl
              overflow-hidden
          ...
          <div className="w-full md:w-1/2 flex">
            <div
              className="
                ...
                rtl:md:rounded-tr-0 rtl:md:rounded-tl-2xl rtl:md:rounded-br-0 rtl:md:rounded-bl-2xl
              "
            >
              {/* Title */}
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center bg-white rounded-2xl px-4 py-3 shadow-sm">
                  ...
                  <button
                    ...
                    className="ltr:ml-2 rtl:mr-2 text-gray-400 hover:text-gray-600"
                  >
